...
function App() {
  ...
  // getting a random number and setting it to selected variable
  const getNextAnecdote = () => setSelected(getRandomNumber());

  // getting the index of maximum number from votes array
